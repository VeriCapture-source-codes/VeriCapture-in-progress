...
import property1moon from './assets/property1moon.png';
import property1sun from './assets/Property1sun.png';
...
const Profile = () => {
  ...
  const openModal = (modalName) => {
    ...
    setModals({ ...prev, [modalName]: true });
  };

  // Close modal
  const closeModal = (modalName) => {
    console.log('Closing modal:', modalName);
    setModals({ ...prev, [modalName]: false });
  };
